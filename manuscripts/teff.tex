...
the C-H bond autocorrelation function (Eq.~\eqref{eq:BCF}) is often written as a product %of two functions
\begin{equation}
...
It is easily seen that in the presence of more long-lived correlations $\tau_\mathrm{e}$ grows, signaling that more time is needed for full conformational sampling.\todo{Redundant sentence?}
