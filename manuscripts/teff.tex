...
Since $S_{\rm{CH}}$ describe the conformational ensemble of the molecule, the fast-decaying component of the rotational correlation function intuitively reflects the time needed to sample these conformations.
...
While the $\tau_\mathrm{e}$ detect essentially an average over all the time scales relevant for the lipid internal dynamics, and
have an intuitive relation to dynamics, 
%Most importantly, i
...
with timescales near the inverse of $\omega_{\mathrm{H}}$ and $\omega_{\mathrm{C}}$ which depend on the field strength used in the NMR experiments; typically
