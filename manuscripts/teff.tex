...
%
All the experimental quantities used in this work were collected from the literature sources cited at the respective figures.   
...
\begin{table}[t!]
\caption{Analyzed simulations of pure POPC lipid bilayers at full hydration.}
...
\begin{table}[]
\caption{Analyzed simulations of cholesterol-containing POPC bilayers at full hydration.}
\begin{minipage}[t]{\columnwidth}
\resizebox{\columnwidth}{!} {
...
\begin{table}[]
\caption{Analyzed simulations of PC lipid bilayers under varying hydration level.}
\begin{minipage}[t]{\columnwidth}
\resizebox{\columnwidth}{!} {
...
the $R_1$ from simulations was obtained as an average over all such overlapping carbons.
%
